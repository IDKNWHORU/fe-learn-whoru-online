  ...
  return (
    <>
      {selector == null ? null : !selector.isSignedIn() ? (
        <div className={`${style.card_mywallet} ${style.card_mywallet_blur}`}>
          <div className={style.mywallet}>
            <div className={style.mywallet_text}>
              <h4 className={style.h4_18}>나의 지갑</h4>
            </div>
            <div
              className={`${style.wallet_logo_mywallet_information} ${style.zero_padding}`}
            >
              <hr className={style.divder_blur} />
              <div className={style.wallet_logo_with_button}>
                <div
                  className={`${style.wallet_logo} ${style.wallet_logo_blur}`}
                >
                  <Icon
